...
```
    ...
    inflan_001 weight in kilograms: 60.3
...
```
    ...
    Using 0 to begin range: Monady
    Omitting beginning index: Monady
...
[10]: print('middle value in data', data[29,19])
middle value in data 16.0
[12]: print(data[0:4, 0:10])
[[0. 0. 1. 3. 1. 2. 4. 7. 8. 3.]
[0. 1. 2. 1. 2. 1. 3. 2. 2. 6.]
[0. 1. 1. 3. 3. 2. 6. 2. 5. 9.]
[0. 0. 2. 0. 4. 2. 2. 1. 6. 7.]]
...
[1. 1. 0. 1.]
[2. 2. 1. 1.]]
[17]: # lets use a numpy function
print(numpy.mean(data))
6.14875
[20]: maxval, minval, stdvat = numpy.amax(data), numpy.std(data)
␣
,→---------------------------------------------------------------------------
...
0.0
4.613833197118566
[22]: print('maximum inflammation', maxval)
...
[23]: patient_0 = data[0,:]
print('maximim inflammation for patient 0:', numpy.amax(patient_0))
maximim inflammation for patient 0: 18.0
[24]: print('maximum inflammation for patient 2:', numpy.amax(data[2, :]))
maximum inflammation for patient 2: 19.0
[25]: print(numpy.mean(data, axis = 0))
...
[26]: print(numpy.mean(data, axis = 0).shape)
(40,)
[27]: print(numpy.mean(data, axis = 1))
